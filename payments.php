...
<head>
   ...
   <title>Payments | UW CREDIT UNION | Modern Banking & Personal Finance</title>
   <meta
     name="description"
     content="Business payment solutions at UW CREDIT UNION. Wire transfers, ACH payments, payroll processing, and merchant services for business transactions."
   />
   ...
   <style>
     ...
     * { box-sizing: border-box; }
     ...
     .payment-card h3 { font-size: 1.4rem; margin-bottom: 12px; }
     .payment-card p { margin-bottom: 20px; }
     .features-list {
       display: grid;
       gap: 12px;
       margin-bottom: 24px;
   ...
   <main>
     <header class="page-header">
       <div class="container">
         ...
         <h1>Streamlined business payments.</h1>
         <p style="margin-top: 20px; max-width: 600px;">
           Move money efficiently with comprehensive payment solutions designed for business operations, payroll, and vendor management.
         </p>
         <div style="margin-top: 30px;">
           <a href="login.php" class="btn btn-primary">Start Processing Payments</a>
     ...
     <section class="section">
       <div class="container">
         <div class="section-header">
           ...
           <p>Choose the payment methods that fit your business operations and cash flow needs.</p>
         </div>
         ...
         <div class="payments-grid">
           <article class="payment-card">
             ...
             <p>Secure domestic and international wire transfers for time-sensitive business payments.</p>
             <ul class="features-list">
               <li>Same-day domestic transfers</li>
           ...
           <article class="payment-card">
             <div class="payment-icon" aria-hidden="true">◍</div>
             <h3>ACH Payments</h3>
             <p>Cost-effective batch payments for payroll, vendor payments, and recurring transactions.</p>
             <ul class="features-list">
               <li>Batch processing capabilities</li>
               <li>Next-day settlement options</li>
               <li>Low transaction fees</li>
               <li>Automated recurring payments</li>
               <li>Comprehensive reporting</li>
             </ul>
             <a href="login.php" class="btn btn-primary">Setup ACH</a>
           </article>

           <article class="payment-card">
             <div class="payment-icon" aria-hidden="true">▣</div>
             <h3>Payroll Processing</h3>
             <p>Integrated payroll solutions to pay employees accurately and on time with tax compliance.</p>
             <ul class="features-list">
             ...
             <a href="login.php" class="btn btn-primary">Setup Payroll</a>
           </article>

           <article class="payment-card">
             <div class="payment-icon" aria-hidden="true">◎</div>
             <h3>Vendor Payments</h3>
             <p>Streamlined accounts payable management for efficient vendor and supplier payments.</p>
             <ul class="features-list">
             ...
             <a href="login.php" class="btn btn-primary">Manage Vendors</a>
           </article>

           <article class="payment-card">
             <div class="payment-icon" aria-hidden="true">⎈</div>
             <h3>Remote Deposit Capture</h3>
             <p>Deposit checks remotely from your office using desktop scanners or mobile devices.</p>
             <ul class="features-list">
               <li>Desktop check scanning</li>
               <li>Mobile check deposit</li>
               <li>Same-day processing</li>
               <li>Image archive and retrieval</li>
               <li>Multi-user access</li>
             </ul>
             <a href="login.php" class="btn btn-primary">Setup Remote Deposit</a>
           </article>

           <article class="payment-card">
             <div class="payment-icon" aria-hidden="true">↗</div>
             <h3>International Payments</h3>
             <p>Send payments globally with competitive exchange rates and secure international transfer options.</p>
             <ul class="features-list">
             ...
             <a href="login.php" class="btn btn-primary">Send International</a>
           </article>
         </div>
       </div>
     </section>
