...
<head>
   ...
   <title>Business Services | UW CREDIT UNION | Modern Banking & Personal Finance</title>
   <meta
     name="description"
     content="Comprehensive business services at UW CREDIT UNION. Merchant services, treasury management, business credit cards, and financial advisory for business growth."
   />
   ...
   <main>
     <header class="page-header">
       <div class="container">
         ...
         <h1>Services that power business growth.</h1>
         <p style="margin-top: 20px; max-width: 600px;">
           Beyond accounts and payments, we provide comprehensive business services including merchant processing, treasury management, and strategic financial advisory.
         </p>
         <div style="margin-top: 30px;">
           <a href="register.php" class="btn btn-primary">Explore Business Services</a>
     ...
     <section class="section">
       <div class="container">
         <div class="section-header">
           ...
           <p>Comprehensive solutions designed to support your business operations and growth strategy.</p>
         </div>
         ...
         <div class="services-grid">
           <article class="service-card">
             ...
             <p>Accept payments from customers with comprehensive credit card processing and payment solutions.</p>
           ...
           <article class="service-card">
             ...
             <p>Optimize your cash flow and liquidity with advanced treasury management solutions.</p>
             <ul class="features-list">
               <li>Cash concentration services</li>
               <li>Liquidity management</li>
               <li>Investment and sweep accounts</li>
           ...
           <article class="service-card">
             ...
             <p>Manage business expenses with corporate credit cards featuring rewards and spending controls.</p>
             <ul class="features-list">
               <li>Corporate credit cards</li>
               <li>Employee card management</li>
               <li>Expense tracking and reporting</li>
               <li>Travel and purchase rewards</li>
           ...
           <article class="service-card">
             ...
             <p>Strategic financial guidance from experienced business bankers and advisors.</p>
             <ul class="features-list">
             ...
             <a href="register.php" class="btn btn-primary">Schedule Consultation</a>
           </article>

           <article class="service-card">
             <div class="service-icon" aria-hidden="true">⎈</div>
             <h3>International Banking</h3>
             <p>Support for global business operations with international trade and currency services.</p>
             <ul class="features-list">
             ...
             <a href="register.php" class="btn btn-primary">Explore International</a>
           </article>

           <article class="service-card">
             <div class="service-icon" aria-hidden="true">↗</div>
             <h3>Online Banking for Business</h3>
             <p>Comprehensive digital banking platform designed specifically for business operations.</p>
             <ul class="features-list">
               ...
               <li>Mobile business banking</li>
             </ul>
             <a href="login.php" class="btn btn-primary">Access Business Banking</a>
           </article>
         </div>
       </div>
     </section>
