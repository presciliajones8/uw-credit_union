...
<head>
   ...
   <title>Business Banking | UW CREDIT UNION | Modern Banking & Personal Finance</title>
   <meta
     name="description"
     content="Comprehensive business banking solutions at UW CREDIT UNION. Business accounts, loans, payments, and financial services designed for business growth."
   />
   ...
   <style>
     ...
     * { box-sizing: border-box; }
     ...
     .business-card h3 { font-size: 1.4rem; margin-bottom: 12px; }
     .business-card p { margin-bottom: 20px; }
     .features-list {
       display: grid;
       gap: 12px;
       margin-bottom: 24px;
     ...
     .stats-section p { color: rgba(255,255,255,0.8); }
     .stats-grid {
       display: grid;
    ...
    .stat-item span {
     ...
     @media (max-width: 1100px) {
       ...
       .business-grid, .stats-grid, .footer-grid {
   ...
   <main>
     <header class="page-header">
       <div class="container">
         ...
         <h1>Banking solutions that grow with your business.</h1>
         <p style="margin-top: 20px; max-width: 600px;">
           From startups to established enterprises, UW CREDIT UNION provides the financial tools, accounts, and services your business needs to thrive.
         </p>
         <div style="margin-top: 30px;">
           <a href="register.php" class="btn btn-primary">Open Business Account</a>
           <a href="business-accounts.php" class="btn btn-secondary">View Business Accounts</a>
         </div>
       </div>
     </header>
     ...
     <section class="section">
       <div class="container">
         <div class="section-header">
           ...
           <p>Comprehensive financial services designed for business success at every stage.</p>
         </div>

         <div class="business-grid">
           <article class="business-card">
             <div class="business-icon" aria-hidden="true">▣</div>
             <h3>Business Accounts</h3>
             <p>Checking and savings accounts designed specifically for business operations and cash flow management.</p>
             <ul class="features-list">
               <li>Business checking accounts</li>
               <li>Business savings options</li>
               <li>Multiple user access</li>
               <li>Integrated payroll options</li>
               <li>Transaction monitoring</li>
             </ul>
             <a href="business-accounts.php" class="btn btn-primary">Explore Accounts</a>
           </article>

           <article class="business-card">
             <div class="business-icon" aria-hidden="true">◍</div>
             <h3>Business Loans</h3>
             <p>Financing solutions for equipment, expansion, working capital, and other business needs.</p>
             <ul class="features-list">
               <li>Term loans and lines of credit</li>
               <li>Equipment financing</li>
               <li>Commercial real estate loans</li>
               <li>SBA loan options</li>
               <li>Flexible repayment terms</li>
             </ul>
             <a href="register.php" class="btn btn-primary">Apply for Financing</a>
           </article>

           <article class="business-card">
             <div class="business-icon" aria-hidden="true">⇄</div>
             <h3>Payments & Transfers</h3>
             <p>Streamlined payment processing and money movement for business transactions.</p>
             <ul class="features-list">
             ...
             <a href="payments.php" class="btn btn-primary">View Payment Options</a>
           </article>

           <article class="business-card">
             <div class="business-icon" aria-hidden="true">◎</div>
             <h3>Merchant Services</h3>
             <p>Accept payments from customers with comprehensive merchant processing solutions.</p>
             <ul class="features-list">
             ...
             <a href="business-services.php" class="btn btn-primary">Learn More</a>
           </article>

           <article class="business-card">
             <div class="business-icon" aria-hidden="true">⎈</div>
             <h3>Treasury Management</h3>
               <p>Advanced cash management tools for optimizing business finances and liquidity.</p>
             <ul class="features-list">
             ...
             <a href="business-services.php" class="btn btn-primary">Explore Services</a>
           </article>

           <article class="business-card">
             <div class="business-icon" aria-hidden="true">↗</div>
             <h3>Business Credit Cards</h3>
             <p>Credit solutions designed for business expenses with rewards and management features.</p>
             <ul class="features-list">
               <li>Business credit cards</li>
               <li>Employee card management</li>
               <li>Expense tracking</li>
               <li>Travel rewards</li>
               <li>Spending controls</li>
             </ul>
             <a href="register.php" class="btn btn-primary">Apply for Cards</a>
           </article>
         </div>
       </div>
     </section>
     ...
     <section class="section">
       <div class="container">
         <div class="stats-section">
           ...
           <p style="margin-top: 12px;">Trusted by thousands of businesses for their financial needs.</p>
